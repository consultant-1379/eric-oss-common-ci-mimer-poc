...
*/ -}}
{{- define "eric-oss-common-ci-mimer-poc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-mimer-poc.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-mimer-poc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-mimer-poc.mergeLabels" -}}
  {{- include "eric-oss-common-ci-mimer-poc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}

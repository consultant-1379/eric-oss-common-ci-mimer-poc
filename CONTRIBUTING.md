# Contributing to Mimer POC Repository - Owned by TheHummingbirds

This document describes how to contribute to the Mimer POC Repository - Owned by TheHummingbirds Project.
...
Mimer POC Repository - Owned by TheHummingbirds artifacts are stored in the Gerrit project: [OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-mimer-poc](https://gerrit-gamma.gic.ericsson.se/#/admin/projects/OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-mimer-poc)
  
### Documents

The documentation for this service is located in the [doc folder](https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-mimer-poc/+/master/doc).

To update documents that are not in the referenced folder, contact the service guardians mentioned in the [README.md](https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-mimer-poc/+/master/README.md).
...
The code-review scores and corresponding workflow activities are as follows:
   ...
   [README.md] (https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-mimer-poc/+/master/README.md)